		...
		"biome" : {
			'w0' : {
				...
				'h3' : {
					...
					'height' : 0.9,
					'soil' : 'stone',
					'spawn' : ['boulder', 'stone', 'bush', 'stump'],
					},
				'h4' : {
					'name' : 'Volcano',
					'density' : 5,
			...
			'w3' : {
				'h0' : {
					...
					'height' : 0.55,
					'soil' : 'foliage',
					'spawn' : ['treepine', 'treepine', 'pinecone'],
					},
				'h1' : {
					'name' : 'Forest',
					'density' : 5,
			...
			'w4' : {
				'h0' : {
					...
					'height' : 0.5,
					'soil' : 'foliage',
					'spawn' : ['cattail', 'grass', 'grass', 'stump', 'stump', 'stump', 'stump', 'stump'],
					},
				'h1' : {
					'name' : 'Glade',
					'density' : 25,
					...
					'height' : 0.5,
					'soil' : 'foliage',
					'spawn' : ['cattail', 'grass', 'grass', 'grass', 'rye'],
					},
				'h2' : {
					'name' : 'Marsh',
					'density' : 50,
				...
				'h3' : {
					...
					'height' : 0.5,
					'soil' : 'foliage',
					'spawn' : ['cattail', 'grass', 'grass', 'stump'],
					},
				'h4' : {
					'name' : 'Swamp',
					'density' : 50,
					...
					'height' : 0.5,
					'soil' : 'foliage',
					'spawn' : ['cattail', 'clover', 'grass', 'grass', 'rye', 'stump', 'stump', 'stump'],
					}},
			'w5' : {
				'h0' : {
					'name' : 'Tundra',
